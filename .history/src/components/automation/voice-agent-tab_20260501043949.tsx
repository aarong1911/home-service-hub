...
function VoiceAgentDetail({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // If agent has a Vapi assistant, update it too
      if (agent.vapi_assistant_id) {
        try {
          ...
          // Vapi sync failed but local save succeeded — not critical
          console.warn("Vapi sync failed, local save succeeded");
        }
      }
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="space-y-1">
            ...
            <Select value={voice} onValueChange={setVoice}>
              ...
              <SelectContent>
                {["Rachel", "Sarah", "Emily", "Josh", "Adam", "Antoni"].map(
                  (v) => (
