...
function buildVapiTools(crmTools: VoiceAgent["crm_tools"]): VapiToolDefinition[] {
    ...
    try {
      ...
      const mapped: VoiceAgent[] = data.map((a: any) => {
        ...
        return {
          ...
          end_call_phrases: a.end_call_phrases || "goodbye, bye, thank you bye",
          crm_tools: a.crm_tools || {
            saveLeads: true,
