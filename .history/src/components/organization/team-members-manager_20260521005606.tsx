...
export function TeamMembersManager({
  ...
  // ── Confirm remove state lives here, at the manager level ──
  ...
  const handleConfirmRemove = async () => {
    ...
    setConfirmId(null);
    onRemove(confirmId); // optimistic local update
  ...
  return (
    <div>
      ...
      {/* Confirm remove dialog — rendered once at manager level, not per row */}
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {confirmMember
                ...
                : "This will remove the member from the workspace and delete their account. This cannot be undone."}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
...
function MemberDialog({
  ...
  const [name, setName]             = useState(
    initial?.name && initial.name !== initial.email ? initial.name : ""
  );
