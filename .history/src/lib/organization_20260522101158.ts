...
export const ROLE_GROUPS = [
  {
    ...
    roles: ["owner", "admin", "office_manager"] as Role[],
  },
  {
    label: "📈 Growth & Revenue",
    roles: ["estimator", "sales"] as Role[],
  },
  {
    label: "🛠️ Field Operations",
    roles: ["project_manager", "field_worker"] as Role[],
  },
  {
    label: "🔒 External & Restricted",
    roles: ["accountant", "viewer"] as Role[],
  },
];

// Roles that route to external apps instead of the main platform
