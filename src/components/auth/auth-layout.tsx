  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-canvas">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute -top-32 -left-32 h-[480px] w-[480px] rounded-full bg-primary/25 blur-3xl" />
        <div className="absolute top-1/3 -right-40 h-[520px] w-[520px] rounded-full bg-[oklch(0.78_0.12_220)]/30 blur-3xl" />
        <div className="absolute -bottom-40 left-1/4 h-[460px] w-[460px] rounded-full bg-primary-soft blur-3xl" />
        <div
          className="absolute inset-0 opacity-[0.35]"
          style={{
            backgroundImage:
              "radial-gradient(circle at 1px 1px, oklch(0.55 0.205 262 / 0.08) 1px, transparent 0)",
