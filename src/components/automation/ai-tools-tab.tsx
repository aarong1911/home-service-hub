...
function generateMockOutput(tool: AITool, _values: Record<string, string>): Record<string, string> {
  const output: Record<string, string> = {};
  for (const section of tool.outputSections) {
    switch (section) {
      case "Risk Level":
        output[section] = "🟡 Medium — Deal has been in stage for an extended period";
        break;
      case "Win Probability":
        output[section] = "62% — Based on stage duration and deal characteristics";
        break;
      case "Extracted Task List":
        output[section] = "| Task | Priority | Owner | Due Date | Category |\n|---|---|---|---|---|\n| Follow up with client on tile selection | High | Marcus | Apr 25 | Client Communication |\n| Schedule plumbing rough-in inspection | Medium | Dev | Apr 28 | Scheduling |\n| Order remaining cabinet hardware | Low | Jess | May 2 | Procurement |";
        break;
      case "TL;DR Summary":
        output[section] = "Client is enthusiastic about the project scope but has concerns about timeline. Agreed to proceed with Phase 1 immediately while finalizing Phase 2 details next week.";
        break;
      case "Sentiment Indicator":
      case "Sentiment Analysis":
        output[section] = "😊 Positive — Client expressed enthusiasm and confidence in the team";
        break;
      case "KPI Health Dashboard":
        output[section] = "🟢 Revenue: On Track\n🟡 Lead Volume: Slightly Below Target\n🟢 Conversion Rate: Above Average\n🔴 Pipeline Coverage: Needs Attention";
        break;
      case "Gap to Target":
        output[section] = "Gap: $28,500 remaining to hit quarterly target. At current close rate, you need 3.2 additional deals to close.";
        break;
      case "Pipeline Health Score":
        output[section] = "Score: 72/100 — Good pipeline coverage but velocity needs improvement in Discovery → Estimate stage.";
        break;
      default:
        output[section] = `Analysis complete for "${section}". This section contains AI-generated insights based on the provided inputs. In production, this would connect to the AI engine for real-time analysis and recommendations tailored to your specific data.`;
    }
  }
  return output;
}
